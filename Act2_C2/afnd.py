        ...
        if cadena[0] in s:
            ...
            for i in range(len(estados)):
                for j in range(num_estados):
                    ...
                    if (
                        estados[i][0] == estados_actuales[j]
                        and estados[i][1] == cadena[0]
                    ):
...
boton.grid(row=1, column=0, pady=5, padx=5)
ventana.mainloop()
